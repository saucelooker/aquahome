...
class DetailPageView extends PageWidget<DetailPageViewModel> {
  ...
  final GlobalKey<AnimatedGridState> _key = GlobalKey();
            ...
            child: Column(
              children: [
                Container(
                    ...
                    child: TabBar(
                      onTap: (tab) => viewModel.colorMode =
                          tab == 0 ? ColorMode.gradient : ColorMode.temperature,
          ...
          Consumer<DetailPageViewModel>(
            builder: (context, viewModel, child) => GridView.builder(
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    childAspectRatio:
                        (MediaQuery.of(context).size.width - 20) / 280,
